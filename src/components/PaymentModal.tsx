...
import { X, CreditCard, Coins, Copy, Check, Wallet } from 'lucide-react';
...
const PaymentModal = ({ isOpen, onClose, total }: PaymentModalProps) => {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-background border border-border rounded-2xl shadow-2xl z-[60] max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-heading font-bold">Complete Payment</h2>
